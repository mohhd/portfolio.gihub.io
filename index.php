...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCg0-mtlS8TpcMIGeB0tLlxQ&key=AIzaSyBN8KgVEotN_YsQDVYV_wR2qzi6TeN_w30');
...
//Latest Video
$urllatestVideo = 'https://www.googleapis.com/youtube/v3/search?part=snippet&key=AIzaSyBN8KgVEotN_YsQDVYV_wR2qzi6TeN_w30&channelId=UCg0-mtlS8TpcMIGeB0tLlxQ&maxResults=1&order=date';

$result = get_CURL($urllatestVideo);

$latestVideoId = $result['items'][0]['id']['playlistId'];
?>
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#home">Mohadi</a>
        ...
        <div class="row justify-content-center">
          <div class="col-md-5">
            <div class="row">
              ...
              <div class="col-md-8">
                <h5><?= $youtubeTitle; ?></h5>
                <p><?= $youtubeSubscribe; ?> Subscribers.</p>
              </div>
            </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4">
            ...
            <ul class="list-group mb-4">
              ...
              <li class="list-group-item">Jl. Abdul Rahman, Pabean, Kec.Sedati</li>
